            ...
            "application/x-www-form-urlencoded": {
              schema: {
                ...
                properties: {
                  ...
                  city: { type: "string" },
                  budget: {type: "object", properties: { amount: { type: "number", description: "مبلغ", example: 1000 }, type: { type: "string", enum: [hourly, daily, monthly], description: "نوع پرداخت", example: "hourly" } } },
