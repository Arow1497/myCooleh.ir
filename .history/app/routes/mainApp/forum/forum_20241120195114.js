...
const { PostsController } = require("../../../http/controllers/mainApp/forums/posts.controller");
const { stringToArray } = require("../../../utils/functions");
const { uploadImage, upload } = require("../../../utils/multer");
const router = require("express").Router();


router.post("/create_post", upload, stringToArray("tags"), PostsController.createPost)
router.patch("/edit/:postID", upload, stringToArray("tags"), PostsController.editPostById)
router.post("/add_comment/:postID", PostsController.addCommentForPost)
router.get("/get_comments_ofpost/:postID", PostsController.getCommentsOfPost)
router.delete("/remove/:postID", PostsController.removePostById)
router.get("/get_posts", PostsController.getAllPosts)
router.get("/get_shareLink_ofpost/:postID", PostsController.sharePost)
