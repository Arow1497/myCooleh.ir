...
class ApprenticeshipNoticeController extends Controller {
    async createNewApprenticeRequest(req, res, next) {
        try {
            const result = await noticeService.createNewApprenticeRequest(
                req.user,
                req.body,
                req.params,
                req.files
    ...
    async removeApprenticeRequestById(req, res, next) {
        try {
            await noticeService.removeApprenticeRequestById(req.params.noticeApprenticeId, req.user.id);
            return res.status(HttpStatus.OK).json({
                statusCode: HttpStatus.OK,
    ...
    async editApprenticeRequestsById(req, res, next) {
        try {
            const updatedNotice = await noticeService.editApprenticeRequestsById(
    ...
    async getAllApprenticeRequestsToItself(req, res, next) {
        try {
            const { requests, total } = await noticeService.getAllApprenticeRequestsToItself(
                req.user.id,
                req.query.page,
                req.query.limit,
                req.query.status
    ...
    async shareApprenticeRequest(req, res, next) {
        try {
            const share = await noticeService.shareApprenticeRequest(
                req.params.noticeApprenticeId,
                req.user
            );
            return res.status(HttpStatus.OK).json({
