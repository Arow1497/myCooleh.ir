...
زمانی که مکانیک متقاعد میکنه مشتری رو که قطعه ای بخره یا لاستیک
هاش کهنه هست یا قطعه ایش نیاز به تعویض داره ولی برای اون مورد مراجعه نکرده..
در این حالت ما دو تا سناریو داریم: اولی سناریو بازاریابی مکانیک هست یعنی مکانیک 
مشتری رو راضی میکنه و متقاعدش میکنه که این قطعه و این خدمات رو همین الان انجام بده...
و مشتری راضی میشه بنابراین مکانیک یک متریک با تگ فوری و اماده فروش ثبت میکنه و تامین کننده ها میدونن
که با یک فروش قطعی طرف هستن مثلا تامین کننده های لاستیک یا دیگر قطعات فنی یا تزییناتی حتی مثل روکش صندلی
این کوپن ها درصد بیشتری دارند تامین کننده ها پیشنهاد میزارن و میگن این جنس
انقدر قیمتشه انقدر سهم فروش تو هرکس سهم بیشتری بده طبیعتا انتخاب میشه از طرف گاراژ البته
تضامین کیفی هم مهمه ... نوع دیگه این هست که مکانیک نمیتونه متقاعد کنه مشتری رو پس متریکش رو ثبت میکنه 
و تامین کننده ها میبینند این متریک رو و درخواست گرفتن متریک ثبت میکنن گاراژ ۳ تاشون رو انتخاب میکنه 
و اینها دسترسی پیدا میکنند به اینکه بتونند به اپلیکیشن پی دبلیو ای مشتری پیام تبلیغاتی ارسال کنند..
ـــــــــــــــــــــــــــــــــ
گاهی اوقات هم پیش میاد یه تک قطعه نیازه برای یک بخشی از خودرو که نمیضرفه اوردر تامین
قطعه ثبت بکنی گاراژ یک متریک فوری ثبت میکنه اینجوری تامین کننده رو قانع میکنی که 
این بخش متریک هم خیلی مهمه و فروش های صد در صدی داره با تگ فوری...
اما متریک های تاخیری هم در صورت پیاده سازی یک سازکار مناسب نزدیک میشن به خرید
*/
