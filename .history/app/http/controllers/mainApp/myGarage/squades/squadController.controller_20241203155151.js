...
*
*
* بحث کلن های مخصوص تعویض روغنی ها خیلی مهمه.....
* کوپن هایی که میتونن تامین کننده ها بدن و تعاملاتی که بین اینها شکل میگیره خوراک همین فیچر کلن هست...
* یادت نره هر دسته ای باید کلن خودشون هم  داشته باشن...
* متلا یک صافکار هم توی کلن بقیه مکانیک باشه هم توی کلن تخصصی صافکار و دیتیلا ...
*  دو تا تب داشته باش کلن تخصصی و کلن عمومی 
*
*/
