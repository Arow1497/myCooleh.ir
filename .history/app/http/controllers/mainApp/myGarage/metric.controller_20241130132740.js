...
نکته اول اینکه متریک مختص به قطعات و یدکی ها نیست بلکه بازارش بیشتر خدمات هست مثلا فکر کن یک 
ماشین یک کیس تعمیری در یک گاراژ بوده ولی مشکلی هم داشته
 مثلا یکجای بدنه اش قری داشته البته این میره توی حیطه برونسپاری ....یا لاستیک
