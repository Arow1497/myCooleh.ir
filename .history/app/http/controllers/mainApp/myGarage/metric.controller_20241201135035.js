...
*اینجا لازم میشه ما بدونیم نقاط اشتراک و تفاوت های بخش های مختلف سیستم عزیز ما چی هست..
*ببین ما بخشی داریم تحت عنوان پارت اوردر..حالا اقا اگه اوردر ثبت و تامین شد ولی بازم یه قطعه
*نیاز بود چی؟ جپاب اینه که یه اوردر دیگه ثبت کن ثبت قطعات فنی نباید به صورت پیشفرض ربطی به متریک داشته باشند..
*توی متریک ما موارد خاص رو که مشتری رو راضی کردیم بابتشون هزینه کنه در نظر گرفتیم یعین چی؟
*فرض کن مشتری اومدی مکانیک مکانیک مشکلش رو رفع میکنه و بهش میگه ببین مثلا روکش صندلیت هم یا لاستیکت
*مستهلک شده من میتونم برای تو یک سفارش بزارم و تامین کننده ها بیان جنسشون رو با قیمتشون همراه با عکس
*و مشخصات بهت پیشنهاد بدن.. بهتره که بری از جای دیگه گرون بخری نه؟  اگه خواستی یکیشون رو انتخاب و خرید کن..
*پس مکانیک یه متریک فوری روکش ثبت میکنه تامین کننده ها قیمت و درصد پیشنهادی مکانیک رو پیشنهاد میدن با مشورت 
*مشتری یکیشونو انتخاب میکنه...
*حالا برات روشن شد؟ تفاوتش با کوپن رو متوجه شدی؟ کوپن وقتیه که ما یه دیل بستیم و اجناسشو بازاریابی میکنیم
*و میفروشیم.. ولی گاهی وقتا مشتری راضیه بخره ولی ما که دیل نبستیم با کسی پس اون قطعه رو اگهی متریک فوری میکنیم
*/
