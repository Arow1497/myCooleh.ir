/*
* مکانیک اول از لیست درخواست های پذیرش موراد رو اکسپت میکنه بعد میره توی بخش ایجاد پروژه
* اونجا مواردی که اکسپت کرده میتونه ببینه با یکی از اونها درخواست ثبت پروژه و ثبت مشخصات
*انجام میدهو در مرحله بعد بررسی و ثبت اینسپکشن که درخواست های اولیه صفحه ی 
* partOrderController هستن رو انجام میده
* و درنهایت ثبت اوردر قطعات میکنه
*/
