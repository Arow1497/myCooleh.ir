...
تامین کننده کوپن رو ثبت میکنه با مقدار درصد سود از هر فروش به علاوه قیمت تقریبی روز 
قطعه...بعد گاراژ اون رو به کوله خودش اضافه میکنه...گاراژ در زمان تعمیر یک کیس 
و تامین قطعه قطعاتی که توی لیست کوپن های خریداری شدش هست به اوردر اضافه میشه
به ظور خودکار یعنی پلتفرم مکانیک رو موظف میکنه که به کوپن ها پایبند باشه...
چون باید حتما اسم و نپوع قطعه رو برای اوردر درخواست قطعه هم وارد کنه دیگه زیرآبی نمیتونه
بره...
