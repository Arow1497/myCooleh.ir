...
const { MongoError, MongoNotConnectedError, MongoExpiredSessionError } = require('mongodb');
...
handleProcessShutdown() {
    ...
    process.on('unhandledRejection', (reason, promise) => {
        ...
        if (
            reason instanceof MongoNotConnectedError || 
            reason instanceof MongoExpiredSessionError
        ) {
