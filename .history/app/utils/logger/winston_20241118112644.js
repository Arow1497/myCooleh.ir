...
// 1. تعریف levels به صورت مستقیم در winston
winston.loggers.add('custom-logger', {
  levels: {
    error: 0,
    warn: 1,
    info: 2,
...
// 2. گرفتن نمونه logger
const winstonLogger = winston.loggers.get('custom-logger');

// 3. ساخت یک wrapper ساده
const logger = {
...
// 5. تست logger
// برای اطمینان از کارکرد درست، یک تست انجام میدیم
try {
  ...
  console.log('Logger initialized successfully with all methods');
} catch (error) {
