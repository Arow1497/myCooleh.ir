...
const createTransports = () => {
  ...
  Object.entries(LOG_CATEGORIES).forEach(([categoryName, category]) => {
    category.types.forEach(type => {
      const transport = createRotateTransport(category, type);
      transport.name = `${categoryName}-${type}`; // Add name to the transport
  ...
  mongoTransport.name = 'MongoDB'; // Add name to the MongoDB transport
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    consoleTransport.name = 'Console'; // Add name to the console transport
