...
const logger = winston.createLogger({
  ...
  transports: [
      ...
      new winston.transports.DailyRotateFile({
        filename: path.join(LOG_DIR, 'error-%DATE%', '%H00.log'),  // اضافه کردن 00 به آخر ساعت
        datePattern: 'YYYY-MM-DD',                    // الگوی تاریخ برای نام پوشه
        level: 'error',
        maxSize: '20m',
        maxFiles: '14d',
        zippedArchive: true,
      ...
      // Combined logs
      new winston.transports.DailyRotateFile({
        filename: path.join(LOG_DIR, 'combined-%DATE%', '%H00.log'),
