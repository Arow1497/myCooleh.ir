...
به عنوان middleware در روت‌ها

javascriptCopyrouter.get('/notices', geoFilterHandler, async (req, res) => {
  const nearbyNotices = req.filteredRecords;
  ...
});

در صف کارها

javascriptCopyconst results = await processGeoFilter({
